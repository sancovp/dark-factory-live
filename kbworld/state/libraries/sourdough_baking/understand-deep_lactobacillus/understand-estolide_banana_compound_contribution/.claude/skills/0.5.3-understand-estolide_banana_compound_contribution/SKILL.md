---
name: 0.5.3-understand-estolide_banana_compound_contribution
description: [0.5.3] Isoamyl acetate and related estolide esters producing characteristic banana notes that add tropical fruit dime
---

# understand-estolide_banana_compound_contribution

**CALL NUMBER:** `deep_lactobacillus.estolide_banana_compound_contribution : deep_fermentation(25), sourdough_baking(5)`
**DEFINITION:** Isoamyl acetate and related estolide esters producing characteristic banana notes that add tropical fruit dimension to sourdough flavor

Invoke this skill to understand `estolide_banana_compound_contribution` down to its primitives. The RELATIVE ROOT below is the least-fixed-point closure of everything it bundles from — the full import cone, grouped by the lib each prim comes from. Projected from a prover-typed KB (MAP/SWI-Prolog consistency gate): every reference below resolves.
