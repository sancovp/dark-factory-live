---
name: 0.3.6-understand-fold_count_8
description: "[0.3.6] The degree to which the number of folds produces visible and tactile improvements in dough_strength and gluten"
---

# understand-fold_count_8

**CALL NUMBER:** `deep_bulk_fermentation.fold_count_8 : sourdough_baking(4)`
**DEFINITION:** The degree to which the number of folds produces visible and tactile improvements in dough_strength and gluten_development, measurable by dough extensibility and windowpane test.

Invoke this skill to understand `fold_count_8` down to its primitives. The RELATIVE ROOT below is the least-fixed-point closure of everything it bundles from — the full import cone, grouped by the lib each prim comes from. Projected from a prover-typed KB (MAP/SWI-Prolog consistency gate): every reference below resolves.
