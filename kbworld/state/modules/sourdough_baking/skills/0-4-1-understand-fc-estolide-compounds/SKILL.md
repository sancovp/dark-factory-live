...
`atd_lingering_ester_notes`, `estolide_formation_reaction`, `flavor_complexity`, `isoamyl_acetate`, `lactobacillus_esterase_activity`, `le_estolide_formation`, `wild_yeast_esterase_activity`
