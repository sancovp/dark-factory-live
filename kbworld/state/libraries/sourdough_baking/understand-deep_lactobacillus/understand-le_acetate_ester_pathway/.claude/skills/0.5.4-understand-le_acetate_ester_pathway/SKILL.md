---
name: 0.5.4-understand-le_acetate_ester_pathway
description: [0.5.4] The specific esterification route wherein lactobacillus_esterase_activity catalyzes the reaction of acetic_aci
---

# understand-le_acetate_ester_pathway

**CALL NUMBER:** `deep_lactobacillus.le_acetate_ester_pathway : deep_fermentation(29), sourdough_baking(5)`
**DEFINITION:** The specific esterification route wherein lactobacillus_esterase_activity catalyzes the reaction of acetic_acid with ethanol to form acetate esters contributing to sharp, vinegar-like aromatic nuances in sourdough headspace.

Invoke this skill to understand `le_acetate_ester_pathway` down to its primitives. The RELATIVE ROOT below is the least-fixed-point closure of everything it bundles from — the full import cone, grouped by the lib each prim comes from. Projected from a prover-typed KB (MAP/SWI-Prolog consistency gate): every reference below resolves.
...
`lapp_acetate_bias`, `lapp_dual_donor_capacity`, `lapp_flavor_output_signature`, `le_activity`
