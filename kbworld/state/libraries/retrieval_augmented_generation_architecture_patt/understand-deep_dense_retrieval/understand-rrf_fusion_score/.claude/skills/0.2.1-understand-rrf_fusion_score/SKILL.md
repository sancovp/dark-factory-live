---
name: 0.2.1-understand-rrf_fusion_score
description: [0.2.1] The sum of reciprocal rank values for a given document across all contributing rank lists; the document's posi
---
