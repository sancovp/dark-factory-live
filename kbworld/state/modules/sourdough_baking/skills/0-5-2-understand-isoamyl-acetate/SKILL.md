---
name: 0.5.2-understand-isoamyl_acetate
description: "[0.5.2] The primary ester compound (3-methylbutyl acetate) responsible for banana_ester_notes in sourdough. Formed thr"
---

# understand-isoamyl_acetate

**CALL NUMBER:** `deep_lactobacillus.isoamyl_acetate : deep_fermentation(21), sourdough_baking(5)`
