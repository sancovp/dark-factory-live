---
name: 0.3.2-understand-write_lock_held_until_commit
description: "[0.3.2] exclusive lock discipline in read_committed requiring a transaction to hold write locks on modified rows until"
---
