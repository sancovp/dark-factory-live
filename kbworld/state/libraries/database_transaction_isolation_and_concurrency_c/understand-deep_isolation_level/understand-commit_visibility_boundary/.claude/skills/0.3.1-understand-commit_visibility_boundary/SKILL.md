---
name: 0.3.1-understand-commit_visibility_boundary
description: [0.3.1] temporal threshold in read_committed: a datum is visible iff its committing_transaction committed before the r
---
