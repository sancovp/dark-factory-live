---
name: 0.1.1-understand-sequentially_consistent
description: [0.1.1] The strongest memory ordering requiring a single total order of all sequentially consistent operations visible
---
