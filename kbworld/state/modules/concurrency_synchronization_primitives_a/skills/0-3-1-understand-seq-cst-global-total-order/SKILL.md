---
name: 0.3.1-understand-seq_cst_global_total_order
description: "[0.3.1] A single total order of all sequentially consistent operations that is visible and agreed upon by all threads "
---
