---
name: 0.4.1-understand-microservices_architecture
description: "[0.4.1] An architectural style that structures an application as a collection of small, autonomous, loosely-coupled se"
---
