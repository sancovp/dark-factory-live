---
name: 0.3.4-understand-dur_write_ahead_logging
description: "[0.3.4] A protocol mandating that log records describing modifications be flushed to durable_storage before the corres"
---
