---
name: 0.3.5-understand-uncommitted_change
description: [0.3.5] A modification to database state made by a transaction that has not yet committed; visible to other transactio
---
