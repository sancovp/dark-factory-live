---
name: 0.1.6-understand-partial_effects_undone
description: "[0.1.6] The invariant that upon rollback all modifications performed by the transaction are reversed to match the befo"
---
