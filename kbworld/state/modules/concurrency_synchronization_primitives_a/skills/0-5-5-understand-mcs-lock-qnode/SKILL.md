---
name: 0.5.5-understand-mcs_lock_qnode
description: "[0.5.5] Thread-local queue node containing locked flag and successor pointer; must be cache-aligned and allocated per-"
---
