---
name: 0.4.2-understand-replicated_log
description: "[0.4.2] Ordered log of commands maintained across replicas; foundation of state machine replication."
---

# understand-replicated_log

**CALL NUMBER:** `distributed_consensus_and_replication_protocols.replicated_log : deep_raft(6)`
**DEFINITION:** Ordered log of commands maintained across replicas; foundation of state machine replication.

Invoke this skill to understand `replicated_log` down to its primitives. The RELATIVE ROOT below is the least-fixed-point closure of everything it bundles from — the full import cone, grouped by the lib each prim comes from. Projected from a prover-typed KB (MAP/SWI-Prolog consistency gate): every reference below resolves.
...
`a007`, `a008`, `append_entries`, `commit_index`, `follower`, `ft004`, `ft015`, `leader`, `multi_paxos`, `raft`, `smr`, `state_machine_replication`
