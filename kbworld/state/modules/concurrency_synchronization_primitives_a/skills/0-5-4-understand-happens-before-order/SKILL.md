---
name: 0.5.4-understand-happens_before_order
description: "[0.5.4] A transitive, irreflexive partial order over operations in a memory model that defines which operations must a"
---
