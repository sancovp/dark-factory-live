---
name: 0.2.3-understand-output_token_limit
description: [0.2.3] The portion of context_length reserved for generated tokens; equals context_length minus input_token_budget mi
---

# understand-output_token_limit

**CALL NUMBER:** `deep_context_window.output_token_limit`
**DEFINITION:** The portion of context_length reserved for generated tokens; equals context_length minus input_token_budget minus overhead tokens.

Invoke this skill to understand `output_token_limit` down to its primitives. The RELATIVE ROOT below is the least-fixed-point closure of everything it bundles from — the full import cone, grouped by the lib each prim comes from. Projected from a prover-typed KB (MAP/SWI-Prolog consistency gate): every reference below resolves.
...
`context_length`, `input_token_budget`
