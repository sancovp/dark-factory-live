---
name: 0.7.2-understand-memory_order_acquire
description: "[0.7.2] Memory ordering barrier ensuring all loads and stores after the barrier in program order cannot be reordered b"
---
