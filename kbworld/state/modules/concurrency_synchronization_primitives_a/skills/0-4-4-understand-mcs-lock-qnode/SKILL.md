---
name: 0.4.4-understand-mcs_lock_qnode
description: "[0.4.4] Thread-local queue node containing locked flag and successor pointer; must be cache-aligned and allocated per-"
---
