---
name: 0.7.4-understand-happens_before
description: [0.7.4] transitive closure of program_order and synchronizes_with relations; the ordering guarantee that prevents data
---
