---
name: 0.3.1-understand-memory_order_relaxed_atomicity_guarantee
description: [0.3.1] The indivisibility guarantee that a relaxed atomic operation completes as a single indivisible step; no interm
---
