---
name: 0.5.2-understand-elc_esterase_activity
description: [0.5.2] Lactobacillus-derived esterase enzymes that catalyze condensation reactions between hydroxy fatty acids and fa
---

# understand-elc_esterase_activity

**CALL NUMBER:** `deep_lactobacillus.elc_esterase_activity : deep_fermentation(9)`
**DEFINITION:** Lactobacillus-derived esterase enzymes that catalyze condensation reactions between hydroxy fatty acids and fatty acids, forming estolide linkages.

Invoke this skill to understand `elc_esterase_activity` down to its primitives. The RELATIVE ROOT below is the least-fixed-point closure of everything it bundles from — the full import cone, grouped by the lib each prim comes from. Projected from a prover-typed KB (MAP/SWI-Prolog consistency gate): every reference below resolves.

## THE RELATIVE ROOT (the import cone, by lib)

### from `deep_fermentation`
- **estolide_microbial_esterase_activity** (d1): Enzymatic activity secreted by lactobacillus and wild_yeast strains that mediates ester bond formation and cleavage, directly governing estolide synthesis rates in the sourdough matrix.
- **estolide_moiety** (d1): A fatty acid ester linkage formed by condensation of a hydroxy fatty acid hydroxyl group with another fatty acid carboxyl group, creating a dimeric or oligomeric ester structure that serves as the foundational chemical scaffold for sourdough estolide compounds.
