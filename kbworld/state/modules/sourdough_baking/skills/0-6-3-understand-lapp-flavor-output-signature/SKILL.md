---
name: 0.6.3-understand-lapp_flavor_output_signature
description: "[0.6.3] The characteristic ratio of fruity_ester_notes and floral_ester_notes (from lactate esters) versus sharp vineg"
---

# understand-lapp_flavor_output_signature

**CALL NUMBER:** `deep_le_activity.lapp_flavor_output_signature : deep_fermentation(29), deep_lactobacillus(7), sourdough_baking(5)`
**DEFINITION:** The characteristic ratio of fruity_ester_notes and floral_ester_notes (from lactate esters) versus sharp vinegar-like nuances (from acetate esters) in the final sourdough aroma profile resulting from lapp_pathway_allocation_ratio.

Invoke this skill to understand `lapp_flavor_output_signature` down to its primitives. The RELATIVE ROOT below is the least-fixed-point closure of everything it bundles from — the full import cone, grouped by the lib each prim comes from. Projected from a prover-typed KB (MAP/SWI-Prolog consistency gate): every reference below resolves.
