---
name: 0.5.5-understand-estolide_temporal_aftertaste_role
description: "[0.5.5] The position and shape estolide compounds occupy in the temporal_aftertaste_curve contributing fruity peaks an"
---

# understand-estolide_temporal_aftertaste_role

**CALL NUMBER:** `deep_lactobacillus.estolide_temporal_aftertaste_role : deep_fermentation(25), sourdough_baking(5)`
**DEFINITION:** The position and shape estolide compounds occupy in the temporal_aftertaste_curve contributing fruity peaks and plateaus during decay phase

Invoke this skill to understand `estolide_temporal_aftertaste_role` down to its primitives. The RELATIVE ROOT below is the least-fixed-point closure of everything it bundles from — the full import cone, grouped by the lib each prim comes from. Projected from a prover-typed KB (MAP/SWI-Prolog consistency gate): every reference below resolves.
...
- **temporal_aftertaste_curve** (d1): The time-based trajectory of aftertaste sensation intensity from moment of swallowing through gradual decay to baseline, characterized by rise, peak, plateau, and fade phases.
