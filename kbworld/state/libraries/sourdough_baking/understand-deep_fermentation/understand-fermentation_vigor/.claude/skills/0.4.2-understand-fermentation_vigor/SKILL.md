---
name: 0.4.2-understand-fermentation_vigor
description: [0.4.2] Intensity and rate of the combined microbial fermentation process in sourdough, driven by wild_yeast gas produ
---

# understand-fermentation_vigor

**CALL NUMBER:** `deep_fermentation.fermentation_vigor : sourdough_baking(5), deep_lactobacillus(2)`
...
### from `?`
- **crumb_porosity** (d1): The size, distribution, and uniformity of gas pockets in bread crumb created by carbon_dioxide expansion within the gluten network during fermentation, determining whether the crumb structure is open and honeycomb-like or tight and dense.
...
- **lingering_sensation_duration** (d2): The time interval from swallowing to complete disappearance of flavor perception, shaped by organic_acid_persistence and aroma_compound_retention in the crumb matrix.
...
- **estolide_contribution_to_complexity** (d7): The specific manner by which estolide_compounds enhance sourdough flavor complexity through fruity floral and tropical aroma contributions that layer upon organic_acid tanginess
