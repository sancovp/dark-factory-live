...
CALL NUMBER: `deep_fermentation.fermentation_byproducts : sourdough_baking(5), deep_lactobacillus(4)`
...
You are the specialist for `fermentation_byproducts` in the 'sourdough baking' knowledge system. Your CERTIFIED TERRITORY (the relative root — everything your concept bundles from):
  ...
  organic_acids [deep_fermentation]: Carbon-chain acids produced by lactobacillus metabolism including lactic_acid and acetic_acid that determine sourness_level and contribute to flavor_complexity.
    ...
    estolide_hydroxy_fatty_acid_precursor [deep_fermentation]: A hydroxy-bearing fatty acid substrate derived from grain lipid oxidation or microbial metabolism that provides the esterification site for estolide formation during sourdough fermentation.
    ...
    hfap_fermentation_timing_factor [deep_lactobacillus]: Temporal dimension of hydroxy fatty acid accumulation in sourdough, where extended fermentation allows progressive lipid oxidation and microbial hydroxylase activity to increase precursor availability for estolide_compounds synthesis.
      ...
      fc_yeast_character [deep_fermentation]: The bready, nutty, sometimes fruity or floral flavor notes contributed by wild_yeast metabolic activity including higher alcohols and their derivatives during fermentation
        ...
        estolide_esterification_pathway [deep_fermentation]: The biochemical condensation reaction between hydroxy fatty acids and fatty acids catalyzed by microbial esterases that produces estolide linkages and water as a byproduct during fermentation.
        estolide_microbial_esterase_activity [deep_fermentation]: Enzymatic activity secreted by lactobacillus and wild_yeast strains that mediates ester bond formation and cleavage, directly governing estolide synthesis rates in the sourdough matrix.
