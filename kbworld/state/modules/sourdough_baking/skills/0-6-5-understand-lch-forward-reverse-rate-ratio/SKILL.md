---
name: 0.6.5-understand-lch_forward_reverse_rate_ratio
description: "[0.6.5] The instantaneous comparison of le_kinetic_properties for esterification versus hydrolysis determining whether"
---

# understand-lch_forward_reverse_rate_ratio

**CALL NUMBER:** `deep_le_activity.lch_forward_reverse_rate_ratio : deep_fermentation(29), deep_lactobacillus(8), sourdough_baking(5)`
**DEFINITION:** The instantaneous comparison of le_kinetic_properties for esterification versus hydrolysis determining whether net accumulation of fc_estolide_compounds occurs at any fermentation moment.

Invoke this skill to understand `lch_forward_reverse_rate_ratio` down to its primitives. The RELATIVE ROOT below is the least-fixed-point closure of everything it bundles from — the full import cone, grouped by the lib each prim comes from. Projected from a prover-typed KB (MAP/SWI-Prolog consistency gate): every reference below resolves.
...
- **fd_starter_vigor_dependency** (d6): The direct relationship between fermentation_vigor of the inoculating starter culture and the rate of fermentation_depth advancement, where highly active starters drive faster organic_acid accumulation and estolide_formation_trajectory compared to sluggish starters.
...
- **le_kinetic_properties** (d2): The catalytic efficiency parameters of lactobacillus_esterase_activity including reaction rate, substrate affinity, turnover number, and Michaelis constant that determine how quickly esterification proceeds under sourdough conditions.
...
- **lch_hydrolysis_rate_parameter** (d1): The kinetic velocity constant describing how quickly estolide_compounds are cleaved by water, dependent on le_kinetic_properties of the aqueous environment in the sourdough matrix.
- **lch_net_accumulation_threshold** (d1): The critical point where forward condensation_rate exceeds hydrolysis_rate, enabling sustained buildup of fc_estolide_compounds in the dough matrix despite continuous water competition.
