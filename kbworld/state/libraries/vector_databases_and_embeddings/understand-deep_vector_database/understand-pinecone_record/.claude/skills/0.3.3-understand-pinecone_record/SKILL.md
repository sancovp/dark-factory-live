---
name: 0.3.3-understand-pinecone_record
description: [0.3.3] A data unit in Pinecone containing id, dense vector values, optional sparse values, and key-value metadata.
---
