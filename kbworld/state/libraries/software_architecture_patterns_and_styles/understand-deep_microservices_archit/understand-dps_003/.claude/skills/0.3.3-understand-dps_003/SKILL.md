---
name: 0.3.3-understand-dps_003
description: [0.3.3] instance_isolation means each service runs its own database server process or cluster, with separate credentia
---
