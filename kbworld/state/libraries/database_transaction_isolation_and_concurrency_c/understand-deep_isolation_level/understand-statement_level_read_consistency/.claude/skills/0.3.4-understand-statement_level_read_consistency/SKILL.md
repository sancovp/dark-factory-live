---
name: 0.3.4-understand-statement_level_read_consistency
description: [0.3.4] guarantee within read_committed that each SQL statement sees all changes committed at the moment that statemen
---
