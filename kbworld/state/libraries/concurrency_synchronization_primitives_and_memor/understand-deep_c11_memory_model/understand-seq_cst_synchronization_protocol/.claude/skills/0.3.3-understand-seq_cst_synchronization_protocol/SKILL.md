---
name: 0.3.3-understand-seq_cst_synchronization_protocol
description: [0.3.3] The protocol by which sequentially consistent operations establish synchronization points between threads; cre
---
...
`seq_cst_atomic_visibility_observation_consistency_rule`, `sequentially_consistent`
