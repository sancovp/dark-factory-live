---
name: 0.7.4-understand-bulk_fermentation
description: "[0.7.4] Primary fermentation phase where the mixed dough rests and ferments before shaping; time and temperature contr"
---
...
- **fc_acid_linger** (d3): The temporal persistence of organic acids on the palate after swallowing, determined by acid strength, concentration, and the buffering capacity of saliva, resulting in sour sensations that extend beyond the initial taste experience.
- **fc_sour_reverb** (d3): The echoing and reverberating quality of sour sensation in the aftertaste, where initial acid perception decays slowly and unevenly, creating wave-like sour peaks that persist after the main flavor has subsided.
...
- **estolide_lactobacillus_contribution** (d3): The specific metabolic output of lactobacillus strains including enzyme secretion and substrate availability that drives estolide compound generation in sourdough fermentation.
...
- **hfap_fermentation_timing_factor** (d4): Temporal dimension of hydroxy fatty acid accumulation in sourdough, where extended fermentation allows progressive lipid oxidation and microbial hydroxylase activity to increase precursor availability for estolide_compounds synthesis.
