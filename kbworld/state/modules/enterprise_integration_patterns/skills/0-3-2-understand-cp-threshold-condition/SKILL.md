---
name: 0.3.2-understand-cp_threshold_condition
description: "[0.3.2] A predicate over channel_state_snapshot values that evaluates to true when purge_trigger should fire, such as "
---
