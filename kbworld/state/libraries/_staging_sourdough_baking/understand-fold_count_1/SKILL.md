...
**CALL NUMBER:** `deep_bulk_fermentation.fold_count_1 : deep_fermentation(34), sourdough_baking(23), deep_lactobacillus(4)`
...
- **fc_acid_linger** (d5): The temporal persistence of organic acids on the palate after swallowing, determined by acid strength, concentration, and the buffering capacity of saliva, resulting in sour sensations that extend beyond the initial taste experience.
- **fc_sour_reverb** (d5): The echoing and reverberating quality of sour sensation in the aftertaste, where initial acid perception decays slowly and unevenly, creating wave-like sour peaks that persist after the main flavor has subsided.
...
- **estolide_moiety** (d5): A fatty acid ester linkage formed by condensation of a hydroxy fatty acid hydroxyl group with another fatty acid carboxyl group, creating a dimeric or oligomeric ester structure that serves as the foundational chemical scaffold for sourdough estolide compounds.
...
- **fc_sweet_fade** (d5): Residual sweetness from grain-derived sugars and fermentation intermediates that slowly diminishes in the aftertaste, providing balance against sour and bitter notes and creating a pleasant conclusion to the flavor experience.
- **estolide_lactobacillus_contribution** (d5): The specific metabolic output of lactobacillus strains including enzyme secretion and substrate availability that drives estolide compound generation in sourdough fermentation.
- **estolide_yeast_contribution** (d5): The specific metabolic output of wild_yeast strains including esterase secretion and ethanol provision that participates in estolide compound formation and aroma profile development.
- **fc_aftertaste_evolution** (d5): The sequential unfolding and transformation of flavor notes during the aftertaste period, where initial sensations fade while secondary and tertiary flavor compounds reveal themselves progressively over time.
- **fc_mouthfeel_linger** (d5): Textural sensations including dryness, astringency, or creaminess that persist in the mouth after swallowing, contributing tactile dimensions to the aftertaste beyond pure taste perception.
...
- **fc_crumb_aroma_trap** (d6): The mechanical retention of volatile aroma compounds within the porous crumb structure that slowly release during chewing and swallowing, contributing delayed and extended flavor contributions to the aftertaste.
- **fc_retro_nasal_release** (d6): The delayed release of volatile aroma compounds through the nasal passage during exhalation after swallowing, causing aftertaste flavors to emerge and evolve as trapped compounds in the crumb and oral cavity gradually vaporize.

### from `deep_lactobacillus`
- **elc_metabolite_pool** (d5): Organic acid and peptide metabolites secreted by lactobacillus that create the chemical environment favoring estolide stability.
...
- **hfap_fermentation_timing_factor** (d6): Temporal dimension of hydroxy fatty acid accumulation in sourdough, where extended fermentation allows progressive lipid oxidation and microbial hydroxylase activity to increase precursor availability for estolide_compounds synthesis.
