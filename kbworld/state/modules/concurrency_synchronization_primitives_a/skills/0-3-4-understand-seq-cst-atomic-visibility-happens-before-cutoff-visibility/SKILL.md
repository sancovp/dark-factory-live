---
name: 0.3.4-understand-seq_cst_atomic_visibility_happens_before_cutoff_visibility
description: "[0.3.4] A seq_cst read cannot observe a write that is ordered after it in the total order; the happens-before relation"
---
