---
name: 0.7.6-understand-acetic_acid
description: "[0.7.6] Sharp sour acid produced by lactobacillus in presence of oxygen creating tangy flavor"
---

# understand-acetic_acid

**CALL NUMBER:** `sourdough_baking.acetic_acid : deep_fermentation(2)`
...
`as_acetic_acid_ratio`, `as_sourness_level`, `fc_acid_balance_ratio`, `fermentation`, `fermentation_byproducts`, `lactobacillus`
