---
name: 0.2.4-understand-memory_order_acquire
description: [0.2.4] Memory ordering barrier ensuring all loads and stores after the barrier in program order cannot be reordered b
---
