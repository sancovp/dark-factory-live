---
name: 0.1.1-understand-revision_traversal
description: [0.1.1] An ordered walk over commits in git's object graph, visiting each revision reachable from one or more starting
---
