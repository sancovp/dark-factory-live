---
name: 0.1.3-understand-recovery_log_entry
description: "[0.1.3] A durable record written to the transaction log capturing a single row modification, containing the transactio"
---
