---
name: 0.3.3-understand-a007
description: [0.3.3] Quorum in agreement: a subset of processes sufficient to guarantee agreement can be reached, typically interse
---

# understand-a007

**CALL NUMBER:** `deep_raft.a007 : distributed_consensus_and_replication_protocols(3)`
**DEFINITION:** Quorum in agreement: a subset of processes sufficient to guarantee agreement can be reached, typically intersecting any valid quorum to ensure overlap.

Invoke this skill to understand `a007` down to its primitives. The RELATIVE ROOT below is the least-fixed-point closure of everything it bundles from — the full import cone, grouped by the lib each prim comes from. Projected from a prover-typed KB (MAP/SWI-Prolog consistency gate): every reference below resolves.
