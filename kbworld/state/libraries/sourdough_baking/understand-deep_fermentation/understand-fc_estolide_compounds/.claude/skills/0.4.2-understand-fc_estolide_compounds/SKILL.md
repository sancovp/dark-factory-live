---
name: 0.4.2-understand-fc_estolide_compounds
description: [0.4.2] Aroma-active ester compounds produced by yeast and lactobacillus that contribute fruity, floral, and sometimes
---
...
- **fce_odor_threshold** (d1): Concentration at which specific estolide compounds become detectable by human olfaction, varying widely by estolide structure and carbon chain length.
...
- **fce_lactate_estolides** (d2): Estolide compounds formed through lactic_acid esterification producing buttery, creamy, and mild fruity notes distinct from sharper acetate estolides.
...
- **fce_floral_note_family** (d3): Aroma quality family contributed by fc_estolide_compounds including rose, lavender, and blossom descriptors arising from shorter-chain estolide structures.

### from `deep_lactobacillus`
- **lactate_estolide_odor_threshold** (d2): Concentration at which specific lactate estolide compounds become detectable by human olfaction varying by carbon chain length and esterification degree
...
`fce_accumulation_dynamics`, `fce_dough_matrix_partitioning`, `flavor_complexity`
