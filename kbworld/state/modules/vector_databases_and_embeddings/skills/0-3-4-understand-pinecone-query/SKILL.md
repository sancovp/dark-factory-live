---
name: 0.3.4-understand-pinecone_query
description: "[0.3.4] A read operation that returns approximate nearest neighbors to a query vector with optional metadata filtering"
---
