---
name: 0.3.1-understand-memory_order_relaxed_vs_acquire
description: [0.3.1] The ordering contrast where acquire_semantics prevents subsequent operations from being reordered before the a
---
