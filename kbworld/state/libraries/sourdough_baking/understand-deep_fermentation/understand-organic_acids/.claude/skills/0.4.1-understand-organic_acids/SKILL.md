---
name: 0.4.1-understand-organic_acids
description: [0.4.1] Carbon-chain acids produced by lactobacillus metabolism including lactic_acid and acetic_acid that determine s
---
...
- **acid_persistence_capacity** (d1): The ability of organic_acids to remain perceptibly present on the palate after swallowing, determined by acid molecular structure, concentration in crumb, and binding affinity to bread matrix components.
- **aftertaste_intensity** (d1): The perceptual strength of lingering sensations measured by how prominently organic_acids and aroma_compounds register on the palate after swallowing, ranging from subtle to pronounced.
- **bitter_finish** (d1): Astringent and slightly drying sensation that signals the end of the eating experience, influenced by phenolic compounds, over-fermented organic_acids, and Maillard reaction byproducts.
...
- **lingering_sensation_duration** (d6): The time interval from swallowing to complete disappearance of flavor perception, shaped by organic_acid_persistence and aroma_compound_retention in the crumb matrix.
...
`acid_generation_rate`, `estolide_contribution_to_complexity`, `fc_aftertaste_development`, `fc_fermentation_depth`, `fermentation_byproducts`, `fermentation_vigor`, `flavor_complexity`, `lactobacillus`
