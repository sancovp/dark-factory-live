---
name: 0.4.4-understand-raft
description: "[0.4.4] Consensus algorithm designed for understandability, using leader election, log replication, and safety viaterm"
---
