---
name: 0.4.3-understand-tree_object
description: "[0.4.3] Type-2 git object listing directory entries as (mode, name, sha1) tuples; represents a single directory snapsh"
---
