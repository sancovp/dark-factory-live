---
name: 0.7.3-understand-mcs_lock_enqueue
description: [0.7.3] Operation appending a thread-local qnode to the queue tail; atomically CASes qnode into tail; on CAS failure, 
---
