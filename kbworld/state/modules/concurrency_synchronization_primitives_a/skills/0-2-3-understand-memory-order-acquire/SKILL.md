---
name: 0.2.3-understand-memory_order_acquire
description: "[0.2.3] Memory ordering barrier ensuring all loads and stores after the barrier in program order cannot be reordered b"
---

# understand-memory_order_acquire

**CALL NUMBER:** `?.memory_order_acquire`
