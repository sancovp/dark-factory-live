---
name: 0.4.4-understand-fc_estolide_compounds
description: "[0.4.4] Aroma-active ester compounds produced by yeast and lactobacillus that contribute fruity, floral, and sometimes"
---

# understand-fc_estolide_compounds

**CALL NUMBER:** `deep_fermentation.fc_estolide_compounds`
...
- **estolide_flavor_complexity_integration** (d1): The contribution of estolide compounds to the overall depth and nuance of sourdough taste through their role as aroma-active esters that layer fruity and floral notes atop the organic_acid sourness profile.
...
- **estolide_microbial_esterase_activity** (d2): Enzymatic activity secreted by lactobacillus and wild_yeast strains that mediates ester bond formation and cleavage, directly governing estolide synthesis rates in the sourdough matrix.
...
`elc_esterase_activity`, `estolide_banana_note_contribution`, `estolide_floral_note_contribution`, `estolide_fruity_note_contribution`, `estolide_pineapple_note_contribution`, `flavor_complexity`
